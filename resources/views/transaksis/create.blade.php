                ...
                <div class="mx-auto py-4 px-4 sm:px-6 lg:px-8 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('transaksis.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="kode_transaksi" class="block mt-1 w-full" type="text" name="kode_transaksi" :value="old('kode_transaksi')" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="tanggal_transaksi" class="block mt-1 w-full" type="date" name="tanggal_transaksi" :value="old('tanggal_transaksi')" />
                            <x-input-error :messages="$errors->get('tanggal_transaksi')" class="mt-2" />
                        </div>

                        <div class="mt-4">
                            <x-input-label for="total_harga" :value="__('Total Harga')" />
                            <x-text-input id="total_harga" class="block mt-1 w-full" type="number" name="total_harga" :value="old('total_harga')" required min="0" step="0.01" />
