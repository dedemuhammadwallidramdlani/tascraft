                    ...
                    <div class="flex items-center justify-between py-5 mb-5">
                        <div class="md:mt-0 sm:flex-none w-72">
                            <form action="{{ route('produks.index') }}" method="GET">
                                <div class="relative">
                                    <input type="text" name="search" placeholder="Cari Nama, Deskripsi, atau Kategori"
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            @forelse($produks as $produk)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td class="px-6 py-2 text-center">{{ $produk->stok }}</td>
                                    <td class="px-6 py-2 text-left">{{ $produk->category }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="px-6 py-4 text-center">Tidak ada produk ditemukan</td>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
                        <div class="relative p-3">
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-700 dark:text-gray-300">
                                    Menampilkan {{ $produks->firstItem() }} hingga {{ $produks->lastItem() }} dari {{ $produks->total() }} produk
                                </span>
